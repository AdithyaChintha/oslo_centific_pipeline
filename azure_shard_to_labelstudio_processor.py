...
class EndToEndShardProcessor:
    ...
    def process_single_shard(self, video_id: str, shard_name: str) -> Optional[Dict[str, Any]]:
    ...
    def run(self, video_id: str, shard_names: List[str], output_file: Optional[str] = None, 
            import_to_ls: bool = False) -> List[Dict[str, Any]]:
...
def main():
    ...
    parser.add_argument("--shards", required=True, help="Comma-separated shard names (e.g., shard_1,shard_2)")
    ...
    output_file = args.output or f"tasks_{args.video_id}_{'_'.join(shard_names)}.json"
...
"""
#working command
python azure_shard_to_labelstudio_processor.py --video_id VID_20250809_094753_00_044 --shards shard_1 --import-to-ls
